...
const Main = (props) => {
    ...
    if (props.selectTempClick) {
        memeList = (
            <div style={{ backgroundColor: '#ccc', borderRadius:'20px', margin:'10px', padding:'10px', height:'450px', overflow:'scroll', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))' }}>
